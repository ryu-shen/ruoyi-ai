...
import org.dromara.system.config.domain.bo.SysDictDataBo;
import org.dromara.system.config.domain.vo.SysDictDataVo;
import org.dromara.system.config.mapper.SysDictDataMapper;
import org.dromara.system.config.service.ISysDictDataService;
	...
	public String selectDictLabel(String dictType, String dictValue) {
		return baseMapper
				.selectOne(new LambdaQueryWrapper<SysDictData>().select(SysDictData::getDictLabel)
						.eq(SysDictData::getDictType, dictType).eq(SysDictData::getDictValue, dictValue))
				.getDictLabel();
	}
