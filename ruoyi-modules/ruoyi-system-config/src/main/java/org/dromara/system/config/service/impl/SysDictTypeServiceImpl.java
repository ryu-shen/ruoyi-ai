package org.dromara.system.config.service.impl;
...
import org.dromara.system.config.domain.SysDictType;
import org.dromara.system.config.domain.bo.SysDictTypeBo;
import org.dromara.system.config.domain.vo.SysDictDataVo;
import org.dromara.system.config.domain.vo.SysDictTypeVo;
import org.dromara.system.config.mapper.SysDictDataMapper;
import org.dromara.system.config.mapper.SysDictTypeMapper;
import org.dromara.system.config.service.ISysDictTypeService;
...
public class SysDictTypeServiceImpl implements ISysDictTypeService, DictService {
	...
	public List<SysDictDataVo> updateDictType(SysDictTypeBo bo) {
		...
		dictDataMapper.update(null, new LambdaUpdateWrapper<SysDictData>()
				.set(SysDictData::getDictType, dict.getDictType()).eq(SysDictData::getDictType, oldDict.getDictType()));
