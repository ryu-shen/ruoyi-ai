...
import org.dromara.system.config.domain.bo.SysConfigBo;
import org.dromara.system.config.domain.vo.SysConfigVo;
	...
	public boolean selectRegisterEnabled(String tenantId) {
		SysConfig retConfig = TenantHelper.dynamic(tenantId, () -> {
			return baseMapper.selectOne(
					new LambdaQueryWrapper<SysConfig>().eq(SysConfig::getConfigKey, "sys.account.registerUser"));
		});
