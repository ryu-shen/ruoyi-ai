...
import org.dromara.system.config.domain.SysConfig;
import org.dromara.system.config.domain.SysDictData;
import org.dromara.system.config.domain.SysDictType;
import org.dromara.system.config.mapper.SysConfigMapper;
...
public class SysTenantServiceImpl implements ISysTenantService {
	...
	public void syncTenantDict() {
		...
		// 获取所有租户编号
		List<String> tenantIds = baseMapper.selectObjs(new LambdaQueryWrapper<SysTenant>()
				.select(SysTenant::getTenantId).eq(SysTenant::getStatus, SystemConstants.NORMAL), x -> {
					return Convert.toStr(x);
				});
